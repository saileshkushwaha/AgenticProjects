...
export function createApp() {
  ...
  app.get("/api/applications/:id", (req, res) => {
    const found = applications.find((a) => a.id === req.params.id);
  ...
  app.post("/api/applications/:id/decision", (req, res) => {
    ...
    found.timeline = found.timeline.map((t) =>
...
// Start only when run directly (not when imported by tests or other modules).
