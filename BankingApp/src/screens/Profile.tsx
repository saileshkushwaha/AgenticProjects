...
export function Profile() {
  ...
  const { data: profileData } = useQuery({ queryKey: ["profile"], queryFn: api.getProfile });
  ...
  const memberSince = profileData?.createdAt ? new Date(profileData.createdAt).toLocaleDateString("en-US", { month: "long", year: "numeric" }) : "N/A";
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="space-y-2"><Label>ZIP Code</Label><Input value={profile.zip} onChange={(e) => setProfile({ ...profile, zip: e.target.value })} /></div>
          </div>
